...
2. **Google Maps** — the Home and Contact pages use the exact Google Maps place listing for Wits Garden Educational Centre. Replace the `src` of both `<iframe class="map-frame">` elements if the school receives a different official listing or embed URL.
